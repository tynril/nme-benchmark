...
{
	@args(10)	public static var a : CircleBenchmark;
	@args(100)	public static var b : CircleBenchmark;
	@args(1000) public static var d : CircleBenchmark;
	@args(10000) public static var c : CircleBenchmark;
}